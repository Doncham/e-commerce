...
class PaymentCommandServiceTest {
	...
	void givenValidOrderId_whenPay_thenChangeOrderStatusAndSavePayment() {
		...
		// when
		PayResponse payResponse = paymentCommandService.pay(request);
	...
	void givenGatewayFailure_whenPay_thenOrderFailedAndPaymentSavedAsFailed() throws
		...
		// when
		PayResponse response = paymentCommandService.pay(request);
	...
	void givenAmountMismatchFromPg_whenPay_thenThrowException() {
		...
		// when & then
		assertThrows(PayAmountMisMatchException.class, () -> paymentCommandService.pay(request));
	}
